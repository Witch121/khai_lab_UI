const data = [
    {
    img: "./src/img/projects/Rectangle 12.png",
    ...
    const createProjectTemplate = (project) => {
        return `
            <article class="project-card">
                ...
                <div class="content">
                    ...
                    <div class="actions">
                        <a href="" class="link">
                            <img class="icon" src="./src/img/logos/Vector_link.png" alt="">
                            Live Preview
                        </a>
                        <a href="" class="link">
                            <img class="icon" src="./src/img/logos/Vector_GIT.png" alt="">
                            View Code
                        </a>
                    </div>
                </div>
        ...
        const dataRender = (data, container) => {
            ...
            if (content === '') {
                container.innerHTML = `<p class = "no_result">There are no items that satisfy the filter</p>`;
            } else {
